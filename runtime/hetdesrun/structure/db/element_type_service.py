...
def fetch_element_types(
    ...
    Returns:
        Dict[Tuple[str, str], ElementTypeOrm]: A mapping from (stakeholder_key, external_id) to ElementTypeOrm.
...
def upsert_element_types(
    ...
    Args:
        ...
        existing_elements (Dict[Tuple[str, str], ElementTypeOrm]): Existing ElementTypeOrm objects mapped by (stakeholder_key, external_id).
